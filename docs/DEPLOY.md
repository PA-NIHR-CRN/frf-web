...
Run
`docker run -e NEXT_PUBLIC_RECAPTCHA_SITE_KEY=XXX -e RECAPTCHA_PROJECT_ID=XXX -e RECAPTCHA_API_KEY=XXX -e DATABASE_URL=XXX -e GOOGLE_ANALYTICS_ID=xxx -e GOOGLE_ANALYTICS_AUTH=xxx -e GOOGLE_ANALYTICS_PREVIEW=xxx -p 3000:3000 frf-web`
