...
export const TypesOfData = ({ heading, children, className }: TypesOfDataProps) => {
  if (!children) return null

  return (
    <div className={className}>
      <h3 className="govuk-heading-s govuk-!-margin-top-5 govuk-!-margin-bottom-3 md:mt-0">{heading}</h3>
