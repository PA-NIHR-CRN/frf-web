...
export interface TypeServiceProviderFields {
   ...
   * @localized false
   */
  geography: EntryFieldTypes.Array<
    EntryFieldTypes.Symbol<'England' | 'Northern Ireland' | 'Scotland' | 'UK wide' | 'Wales'>
  >
  /**
 ...
 * @since 2022-12-02T11:08:46.217Z
 * @version 259
 */
 ...
 * @version 259
 */
export type TypeServiceProvider<Modifiers extends ChainModifiers, Locales extends LocaleCode> = Entry<
