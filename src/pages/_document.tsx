...
'https://www.googletagmanager.com/gtm.js?id='+i+dl+ '&gtm_auth=${process.env.GOOGLE_ANALYTICS_AUTH}&gtm_preview=env-6&gtm_cookies_win=x';f.parentNode.insertBefore(j,f);
